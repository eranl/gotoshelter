...
GoToShelter is an Android application designed to provide real-time emergency alert monitoring and navigation to safety during life-threatening situations. The app monitors emergency notifications and assists users by automatically initiating navigation to the nearest shelter or safe zone.
